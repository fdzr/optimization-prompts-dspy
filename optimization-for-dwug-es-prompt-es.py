...
for quantity in number_items:
    ...
    custom_evaluate(
        ...
        "non-optimized - dwug-es - prompt-es",
        "accuracy-report.txt",
        quantity,
        debug=False,
    )
    ...
    optimized_program.save(
        f"compile-models/sp/es_spt_mipro_optimized_prompt_es_deepseek-70b-q4-{quantity}-items-per-class"
    )
