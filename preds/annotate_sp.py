...
def annotate(port=11434, lm_name='deepseek-r1:1.5b', fprompt="compile-models/sp/en_spt_mipro_optimized_prompt_en_deepseek-q4", ftest='test_dwug_en.csv', shuffle=False):
    prompt_lang = re.findall(r'_(en|es)_', fprompt)[-1]
